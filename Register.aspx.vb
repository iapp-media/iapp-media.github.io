...
Partial Class Register
    ...
    Protected Sub Page_Load(sender As Object, e As EventArgs) Handles Me.Load
        regBtn1.ImageUrl = "/img/register.png"
        regBtn1.Attributes("onmouseover") = "EvImageOverChange(this, 'in');"
        regBtn1.Attributes("onmouseout") = "EvImageOverChange(this, 'out');"
    End Sub

    Protected Sub regBtn1_Click(sender As Object, e As ImageClickEventArgs) Handles regBtn1.Click
        Main.ParaClear()
