...
Zepto(function($){ 
    ...
    $(".create").click(function(){ 
        window.open('../me/capp.aspx?i=' + getPathNoExt(),'_blank', openOption); 
    });
    ...
    $("#sharetwitter").click(function(){ 
        ...
        window.open('http://twitter.com/intent/tweet?text=' + $("head meta[property='og:description']").attr('content'),'_blank', openOption);
    });

    $("#shareline").click(function(){ 
        SendAjax('http://www.iapp-media.com/act/share.aspx?to=3&i=' + getPathNoExt()); 
        window.open('http://line.naver.jp/R/msg/text/?' + $("head meta[property='og:description']").attr('content'),'_blank', openOption);
    });
