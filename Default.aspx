        ...
        <div class="all">
           ...
           <div id="UserInfo">
            ...
            <div class="content">
                ...
                <!-- 增加 -->
                <a href=""><img class="add" src="img/add.png" height="57" width="40" onMouseOut="this.src='img/add.png'" onMouseOver="this.src='img/add02.png'" /></a>
                <!-- 按下增加，呼叫select選擇區域 -->
                ...
                <div class="edit hide">
                  ...
                  <a href=""><img class="button-wod" src="img/button-word.png"></a>
                  <!-- 圖片編輯iframe -->
