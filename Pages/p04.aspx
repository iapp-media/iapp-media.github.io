...
<body style="margin:0px;padding:0;">
    <div style="width: 261px; height:464px">
        <div style="position:relative; width: 261px; height:236px">
            <asp:Image Style="width: 261px; height:236px" ID="Image1" ImageUrl="~/img/basic/p04-1b.jpg" runat="server" />
        </div >
        <div style="float:left; position:relative; width: 125px; height:226px; border:solid 2px red">
             <asp:Image Style="width: 125px; height:226px;" ID="Image2" ImageUrl="~/img/basic/p04-1b.jpg" runat="server" />
        </div>
        <div style="float:left;position:relative; width: 130px; height:226px; border:solid 2px green">
             <asp:Image style="width: 130px; height:226px;"  ID="Image3" ImageUrl="~/img/basic//p04-1b.jpg" runat="server" />
        </div>
