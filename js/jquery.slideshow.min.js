    ...
    a.fn.slideShow = function(b) {
        ...
        this.init = function() {
            ...
            if (this.options.transition.mode != "slideshow") {
                ...
                var b = this.numSlides * this.options.slideSize.width;
                this.find(".slides").css({
                    width: b + "px",
                    position: "absolute"
                });
            ...
            this.find(".page").click(function(b) {
                if (!(c = a(this).data("slideShow"))) {
                    var c = this
                }
                var d = a(this).html();
                if (!(d = parseInt(a(this).html() - 1))) {
                    var d = a(this).parents(".navigation").find(".page").index(a(this))
                }
                b.preventDefault();
                c.gotoSlide(d)
            });
            this.find(".slide").mousemove(function(b) {
                var c = a(this).data("slideShow");
                c.mouse.x = Math.abs(b.clientX - a(this).position().left);
                c.mouse.y = Math.abs(b.clientY - a(this).position().top);
                if (c.mouse.x > c.options.slideSize.width) c.mouse.x = c.options.slideSize.width;
                if (c.mouse.y > c.options.slideSize.height) c.mouse.y = c.options.slideSize.height;
                if (c.options.hoverNavigation) {
                    var d = Math.round((c.numSlides - 1) * c.mouse.x / c.options.slideSize.width);
                    c.gotoSlide(d, true)
                }
            });
            this.find(".slide").mouseenter(function() {
                var b = a(this).data("slideShow");
                b.mouse.over = true;
                if (!b.options.mousePause) {
                    b.stopAuto()
                }
            });
        ...
        this.auto = function() {
            if (!(b = a(this).data("slideShow"))) {
                var b = this
            }
            if (!b.interval && b.options.interval > .001) {
                b.interval = window.setInterval(function() {
                    b.next()
                }, b.options.interval * 1e3)
            }
            return this
        };
        ...
        this.first = function(b) {
            ...
            return c.gotoSlide(0)
        };
        this.next = function() {
            if (!(b = a(this).data("slideShow"))) {
                var b = this
            }
            return b.gotoSlide(+b.current + 1)
        };
        ...
        this.last = function() {
            ...
            return b.gotoSlide(+b.numSlides)
        };
        this.gotoSlide = function(b, c) {
            if (b < 0) {
                b = this.numSlides - 1
            }
            if (b >= this.numSlides) {
            ...
            if (b === this.current) return this;
            var d = this.find(".slide:eq(" + this.current + ")");
            var e = this.find(".slide:eq(" + b + ")");
            var f = function() {
                a(this).removeClass("selected");
                if (!(b = a(this).data("slideShow"))) {
                    var b = this
                }
                b.elm.find(".navigation .page:eq(" + b.current + ")").addClass("selected");
                if (b.current >= 0) {
                    b.elm.find(".navigation .page:not(:eq(" + b.current + "))").removeClass("selected")
                }
                if (!b.mouse.over) {
                    b.auto()
                }
            ...
            if (!(i = a(this).data("slideShow"))) {
                var i = this
            }
            i.stopAuto();
            if (typeof this.options.gotoSlide == "function") {
                this.options.gotoSlide(i, b)
            }
            if (c) {
                d.hide(1, g);
                e.show(1, h)
                ...
                if (typeof this.options.transition.mode == "function") {
                    this.call(this.options.transition.mode, e, d)
                } else {
                    switch (this.options.transition.mode) {
                        default:
                            case "fade":
                            d.fadeOut(this.options.transition.speed, g);e.fadeIn(this.options.transition.speed, h);
                        break;
                        case "slide":
                                if (this.current == -1) {
                                d.hide(0, g);
                                ...
                                d.animate({
                                    width: "hide"
                                }, this.options.transition.speed, g);
                                e.animate({
                                    width: "show"
                                }, this.options.transition.speed, h)
                            }break;
                        case "slideshow":
                                this.find(".slides").animate({
                                left: b * -this.options.slideSize.width
                            }, this.options.transition.speed, f);
                            break
                    }
                }
            }
