<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="profile.aspx.vb" Inherits="AppWeb1._4.profile" %>
    ...
    <form id="form1" runat="server">
        <div class="content">
            ...
            <div class="profile">
                ...
                <div class="store">
                    <p>
                        <asp:LinkButton ID="BtnSend" runat="server">儲存</asp:LinkButton>
                    </p>
                </div>
                <div class="cancel">
                    <p>
                        <%--<a href="#">取消</a>--%>
                         <asp:LinkButton ID="BTCancel" runat="server" OnClientClick="window.parent.ref()">取消</asp:LinkButton>
                    </p>
                </div>
            </div>
        </div>
