    ...
    public partial class Setting : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                DataTable DT = Main.GetDataSetNoNull("select * from Store_info where Store_ID='1'");
                if (DT.Rows.Count > 0)
                {
        ...
        protected void BTplus_Click(object sender, EventArgs e)
        {
            if (TB_Cate.Text != "")
            {
                ...
                Main.ParaAdd("@Store_ID", 1, System.Data.SqlDbType.Int);
        ...
        void getdate()
        {
            Main.FillDDP(CBL_Cate, "select * from Product_Cate where Store_ID=1", "Cate_Name", "idno");
        }
