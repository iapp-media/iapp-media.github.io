...
namespace StoreMana
{
    public partial class ThreeOpen : System.Web.UI.Page
    {
        ...
        protected void BTStep5_Click(object sender, EventArgs e)
        {
            ...
            if (tmp != "")
            {
                System.Web.UI.ScriptManager.RegisterStartupScript(this, this.GetType(), "String", "alert('請填選" + tmp.Substring(1) + "');slider();cut();", true);
                //;slider();cut();
                return;
            }
        ...
        void loadImg()
        {
            ...
            ss.Append("                             <label class=\"PicClick\" onclick=" + "" + "setCurrent('01','" + LPID.Text.Trim() + "')" + "" + ">");
            //ss.Append("                                 <img src=\"img/uploadicon.png\" alt=\"...\"  />");
            ss.Append("                             </label> ");
            ss.Append("                         </li>");
            ss.Append("                         <li> ");
            ss.Append("                               <img id='p02' src='" + p2src + "' class='PicSend'  /> ");
            ss.Append("                             <label class=\"PicClick\" onclick=" + "" + "setCurrent('02','" + LPID.Text.Trim() + "')" + "" + ">");
            //ss.Append("                                 <img src=\"img/uploadicon.png\" alt=\"...\" class=\"PicClick\" />");
            ss.Append("                             </label>");
            ss.Append("                         </li>");
            ss.Append("                         <li> ");
            ss.Append("                                <img id='p03' src='" + p3src + "' class='PicSend'  /> ");
            ss.Append("                             <label class=\"PicClick\" onclick=" + "" + "setCurrent('03','" + LPID.Text.Trim() + "')" + "" + ">");
            //ss.Append("                                 <img src=\"img/uploadicon.png\" alt=\"...\" class=\"PicClick\" />");
            ss.Append("                             </label>");
            ss.Append("                         </li>");
            ss.Append("                         <li>");
            ss.Append("                                 <img id='p04' src='" + p4src + "' class='PicSend' /> ");
            ss.Append("                             <label class=\"PicClick\" onclick=" + "" + "setCurrent('04','" + LPID.Text.Trim() + "')" + "" + ">");
            //ss.Append("                                 <img src=\"img/uploadicon.png\" alt=\"...\" class=\"PicClick\" />");
            ss.Append("                              </label>");
            ss.Append("                         </li>");
            ss.Append("                      </ul> ");
