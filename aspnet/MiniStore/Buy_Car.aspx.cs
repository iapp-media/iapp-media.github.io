        ...
        { 
            ...
            if (GV.Rows.Count > 0)
            {
                for (int i = 0; i < GV.Rows.Count; i++)
                {
                    ...
                    Main.ParaAdd("@Order_No", OrderNo, SqlDbType.NVarChar);
                    Main.ParaAdd("@Item_ID", Main.Cint2(GV.DataKeys[i][0]), SqlDbType.Int);
                    Main.ParaAdd("@AMT", Main.Cint2(GV.Rows[i].Cells[2]), SqlDbType.Int);
                    Main.ParaAdd("@Price", Main.Cint2(GV.Rows[i].Cells[1]), SqlDbType.Int);
