                    ...
                    if (d.Rows.Count > 0)
                    {
                        for (int i = 0; i < d.Rows.Count; i++)
                        {
                            ...
                            if (i == 0)
                            {
                                ...
                                Literal6.Text += "<div class=\"item active\"><img src=\"" + Comm.URL + dw["FilePath"].ToString().Replace("\\", "/") + "\" alt=\"\" style=\"width:100%;height:300px\"><div class=\"carousel-caption\"></div></div>";
                            }
                            else
                            {
                                //Literal5.Text += "<li data-target=\"#carousel-example-generic\" data-slide-to=\"" + i + "\"></li>";
                                Literal6.Text += "<div class=\"item\"><img src=\"" + Comm.URL + dw["FilePath"].ToString().Replace("\\", "/") + "\" alt=\"\" style=\"width:100%;height:300px\"><div class=\"carousel-caption\"></div></div>";
                            }
                        }
                    }
                }
