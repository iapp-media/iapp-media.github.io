...
$("#Search").keypress(function (e) {
    ...
    if (key == 13) {
        window.open("StoreFair.aspx?w=" + encodeURI($("#Search").val()), "_self");
    }
});
...
$("#mSearch").keypress(function (e) {
    var key = window.event ? e.keyCode : e.which;
    if (key == 13) {
        window.open("StoreFair.aspx?w=" + encodeURI($("#mSearch").val()), "_self");
    }
});
...
function toggleMy() {
    if (getValue("fn") == "my") { window.open("StoreFair.aspx", "_self"); } else { window.open("StoreFair.aspx?fn=my", "_self"); }
}
