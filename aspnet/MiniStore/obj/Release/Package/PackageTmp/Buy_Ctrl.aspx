                        ...
                        <ContentTemplate>
                                            ...
                                            <div class="details col-xs-12" runat="server" id="DivDetails">
                                                ...
                                                <div class="Detailsmid">
                                                    ...
                                                    <div class="MonBox">
                                                        ...
                                                        <span runat="server" id="Dtotal" class="TBC">$<asp:Literal ID="LITotal" runat="server" Text='<%# Eval("Total") %>'></asp:Literal></span>
                                                    </div>
                                                    <asp:Literal ID="LIDNo" runat="server" Visible="false" Text='<%# Eval("carID") %>'></asp:Literal>
                                                    <asp:Button ID="BTminus" runat="server" Text="-" CssClass="input-number-decrement" CommandName="CNminus" />
                                                    <asp:TextBox ID="Qty" runat="server" CssClass="input-number" Text='<%# Eval("AMT","{0:0.####}") %>' Enabled="false"></asp:TextBox>
                                                    <asp:Button ID="BTplus" runat="server" Text="+" CssClass="input-number-increment" CommandName="CNplus" />
                                                    <%--                                              舊寫法--%>
                            ...
                            <div class="col-xs-12 libor">
                                <div class="buyCtrlMoney2">
                                    ...
                                    <div class="check">
                                        <asp:CheckBox ID="ChBonus" runat="server" Text="使用折扣" OnCheckedChanged="ChBonus_CheckedChanged" AutoPostBack="true" />
                                    </div>
                                    <p>
