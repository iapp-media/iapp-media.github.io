<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AUL.aspx.cs" Inherits="Login.AUL" %>
...
<body>
    <form id="form1" runat="server">
       ...
       <%--     <a id="backlist" onclick="backlist()" href="" runat="server" visible="false">
            ...
            <img id="showImg" runat="server" class="showImg opacity" src="img/uploadicon.png" /><%--img/picture1.jpg--%>
        </div>
        <div class="upload-img">
            ...
            <asp:Button ID="BTN" data-method="getCroppedCanvas" OnClientClick="compress(),PassBase64()" runat="server" Text="確認" CssClass="compress" OnClick="BTN_Click" />
        </div>
