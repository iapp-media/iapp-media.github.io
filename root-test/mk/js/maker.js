...
function preview(){
	...
	if(imageBase64F1.length>0){
		var parseFile1 = new Parse.File("p01.jpg",{base64:imageBase64F1});//ParseFile 部分
		flag1 = true;//紀錄是否有圖
	}
	if(imageBase64F2.length>0){
		var parseFile2 = new Parse.File("p02.jpg",{base64:imageBase64F2});
		flag2 = true;
	}
	if(imageBase64F31.length>0){
		var parseFile31 = new Parse.File("p03-1.jpg",{base64:imageBase64F31});
		flag31 = true;
	}
	if(imageBase64F32.length>0){
		var parseFile32 = new Parse.File("p03-2.jpg",{base64:imageBase64F32});
		flag32 = true;
	}
	if(imageBase64F33.length>0){
		var parseFile33 = new Parse.File("p03-3.jpg",{base64:imageBase64F33});
		flag33 = true;
	}
	if(imageBase64F41.length>0){
		var parseFile41 = new Parse.File("p04-1.jpg",{base64:imageBase64F41});
		flag41 = true;
	}
	if(imageBase64F42.length>0){
		var parseFile42 = new Parse.File("p04-2.jpg",{base64:imageBase64F42});
		flag42 = true;
	}
	if(imageBase64F43.length>0){
		var parseFile43 = new Parse.File("p04-3.jpg",{base64:imageBase64F43});
		flag43 = true;
	}
	if(imageBase64F5.length>0){
		var parseFile5 = new Parse.File("p05.jpg",{base64:imageBase64F5});
		flag5 = true;
	}
	if(imageBase64F6.length>0){
		var parseFile6 = new Parse.File("p06.jpg",{base64:imageBase64F6});
		flag6 = true;
	}
...
function send(){
	...
	if(imageBase64F1.length>0){
		var parseFile1 = new Parse.File("p01.jpg",{base64:imageBase64F1});//Parse 部分
		flag1 = true;
	}
	if(imageBase64F2.length>0){
		var parseFile2 = new Parse.File("p02.jpg",{base64:imageBase64F2});
